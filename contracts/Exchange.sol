...
contract Exchange {
    ...
    function fillOrder(uint256 _id) public {
        ...
        require(!isOrderFilled[_id], "Exchange: Order is already filled");
    ...
    function _trade(
        ...
        // Fee is paid by the user who fill.ed the order (msg.sender)
        ...
        userTotalTokenBalance[_tokenGet] [msg.sender] -= (_amountGet + 
            _feeAmount);
        userTotalTokenBalance[_tokenGet] [_user] += _amountGive;
        ...
        userTotalTokenBalance[_tokenGive] [msg.sender] += _amountGet;
